<div class="container">
    <div id="myBtnContainer">
        <button class="btn active" onclick="filterSelection('all')"> Ver Tudo</button>
        <button class="btn" onclick="filterSelection('Casamento')"> Casamento</button>
        <button class="btn" onclick="filterSelection('Corporativo')"> Corporativo</button>
        <button class="btn" onclick="filterSelection('Festas')"> Festas</button>
        <button class="btn" onclick="filterSelection('Editorial')"> Editorial</button>
        <button class="btn" onclick="filterSelection('Fotojornalismo')"> Fotojornalismo</button>
    </div>
</div>
<div class="row1">
<?php
...
$query = 'SELECT * FROM `imagens` ORDER BY `id` ASC LIMIT '.$total_reg.' OFFSET '.$offset;
$result = $conn->query($query);
$check = mysqli_num_rows($result);


$vquery = 'SELECT * FROM `imagens`';
